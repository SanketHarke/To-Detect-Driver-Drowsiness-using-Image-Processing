...
root.title("Driver Drowsiness Detection System Using Machine Learning")
...
label_l1 = tk.Label(root, text="Driver Drowsiness Detection System ",font=("Times New Roman", 30, 'bold'),
