...
def Drowsiness():
    ...
    model = load_model('D:/All Code/Project Done/Finalcode_Drawsiness_Detection/finalcode_Drawsiness_Detection/models/cnnCat2.h5')
    path = os.getcwd()
    ...
    while(True):
        ...
        if returnValue[0]:
            ...
            TTS.save('Yawn.mp3')
            os.system('D:/All Code/Project Done/Finalcode_Drawsiness_Detection/finalcode_Drawsiness_Detection/Yawn.mp3')
            sound.play()
        ...
        if(rpred[0]==0 and lpred[0]==0):
            ...
            TTS = gTTS('Wake Up')
            TTS.save('wakeup.mp3')
            os.system('D:/All Code/Project Done/Finalcode_Drawsiness_Detection/finalcode_Drawsiness_Detection/wakeup.mp3')
