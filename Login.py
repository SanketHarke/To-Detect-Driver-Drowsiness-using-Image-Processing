...
#
label_l1 = tk.Label(root, text="___Driver Drowsiness Detection System___",font=("Times New Roman", 30, 'bold'),
...
# bg_lbl=tk.Label(root, width=670,height=490)
...
label_l1 = tk.Label(root, text="** Fake Currency@2023 By __ **",font=("Times New Roman", 10, 'bold'),
